...
The scree plot is harder to interpret. We note that the elbow could suggests we should retain either 1, 3, 5 or 8 factors. 
...
As mentioned above questions 4 and 23 loadings are all below 0.3 which suggests we should try excluding them from the analysis
...
The scree plot is harder to interpret. We note that the elbow could suggests we should retain either 1, 3, 8 or 10 factors. 
