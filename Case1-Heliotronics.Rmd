...
\frac{\tilde y}{y} &= \frac{A \cdot (2X)^{b}}{A \cdot X^{b}} = 2^{b}\\
...
learn_rate1 = 1 - exp(log(2)*B) # I THINK THIS SHOULD JUST BE learn_rate1 = 1 - 2^B, because log(y)=log(A)+B*log(x)
print(learn_rate1)
...
learn_rate2 = 1-prog_ratio #YES THIS IS CORRECT I BELIEVE
print(learn_rate2)
...
```{r predict cost}
# set A and B
# HERE I WOULD TRY AND KEEP NOTATION CONSISTANT AND USE DIFFERENT VARIABLE FOR A <- exp_curve_pred$coefficients[1] SUCH AS a instead of A
