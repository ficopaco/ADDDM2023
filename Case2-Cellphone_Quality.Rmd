...
cel_data_quests <- cel_data[,c(9:41)]
cel_data_quests <- na.omit(cel_data_quests)
```
...
plotNormalHistogram(cel_data$qd23, main = paste("Frequency Distribution of QD23"))
plotNormalHistogram(cel_data$wtp1, main = paste("Frequency Distribution of WTP1"))
plotNormalHistogram(cel_data$ri1, main = paste("Frequency Distribution of RI1"))
...
#Null hypothesis is that there is no correlation (all are uncorrelated) and the pvalue belo 0.05 indicates that they are
```
