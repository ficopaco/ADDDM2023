...
cd_PC1 <- psych::principal(cel_data_quests, rotate="varimax",nfactors=9, scores=TRUE)
sort(PC1$communality)

plot(PC1$values,xlab="Factor Number",
     ylab="Eigenvalue",
     main="Scree plot",
     cex.lab=1.2,
     cex.axis=1.2,
...
print(cd_PC1$loadings, cutoff=0.3,sort=TRUE)
