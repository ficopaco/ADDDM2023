...
KMOTEST
KMO_list <- data.table(sort(KMOTEST$MSA))
KMO_list
KMOTEST$KMO

KMOTEST$MSA[paste("qd",1, sep="")]
KMOTEST$MSA[1]
...
# 
#display results
row_spec(kable_minimal(kbl(KMO_list)), which(KMO_list[,2]>KMOTEST$KMO), bold = T, color = "white", background = "#78BE20")
